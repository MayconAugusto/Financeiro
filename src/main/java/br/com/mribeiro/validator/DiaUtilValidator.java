package br.com.mribeiro.validator;
...
public class DiaUtilValidator implements Validator {
	...
	public void validate(FacesContext context, UIComponent component,
		...
		if(diaDaSemana < Calendar.MONDAY || diaDaSemana > Calendar.FRIDAY) {
			throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, "Data inválida.", "A data informada não é um dia util."));
		}
